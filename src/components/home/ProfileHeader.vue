    ...
    >
      ...
      <div class="flex items-center gap-3 mt-2">
        ...
        <button
          ...
          class="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#25D366] hover:bg-[#20BA5A] flex items-center justify-center transition-colors shadow-md hover:shadow-lg"
        ...
        <button
          ...
          class="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCAF45] hover:from-[#6B2A95] hover:via-[#E01A1A] hover:to-[#E59E3A] flex items-center justify-center transition-all shadow-md hover:shadow-lg"
        ...
        <button
          ...
          class="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#1877F2] hover:bg-[#166FE5] flex items-center justify-center transition-colors shadow-md hover:shadow-lg"
