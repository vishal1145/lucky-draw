<template>
  <div class="min-h-screen bg-indigo-100 font-roboto w-full flex flex-col items-center justify-center px-4 lg:px-8 relative overflow-hidden">
    ...
    <div class="w-full text-center flex flex-col items-center justify-center mt-16 sm:mt-20 md:mt-24 pb-8 sm:pb-12 md:pb-16 max-w-4xl mx-auto">
      ...
      <div class="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full max-w-2xl">
        <button
          @click="goToHome"
          class="flex-1 px-6 sm:px-8 py-2 sm:py-2.5 bg-indigo-600 text-white rounded-full font-semibold text-base sm:text-lg hover:bg-indigo-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 cursor-pointer"
        >
          Book Consultation Now
        </button>
        <!-- Social Share Section -->
        <div class="flex-1 flex flex-col items-center justify-center">
          <p class="text-gray-600 mb-3 text-sm sm:text-base font-medium">OR share with</p>
          <div class="flex items-center justify-center gap-3 sm:gap-4">
            <!-- WhatsApp Button -->
            <button
              @click="shareOnWhatsApp"
              class="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#25D366] hover:bg-[#20BA5A] flex items-center justify-center transition-all shadow-md hover:shadow-lg border-2 border-white cursor-pointer transform hover:scale-110"
            ...
            <button
              ...
              class="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCAF45] hover:from-[#6B2A95] hover:via-[#E01A1A] hover:to-[#E59E3A] flex items-center justify-center transition-all shadow-md hover:shadow-lg border-2 border-white cursor-pointer transform hover:scale-110"
            ...
            <button
              ...
              class="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#1877F2] hover:bg-[#166FE5] flex items-center justify-center transition-all shadow-md hover:shadow-lg border-2 border-white cursor-pointer transform hover:scale-110"
